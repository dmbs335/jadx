...
launch4j {
	...
	errTitle.set("jadx startup error")
	messagesJreNotFoundError.set("No compatible Java runtime was found. Use the with-jre-win package or install 64-bit Java 11 or newer.")
	messagesJreVersionError.set("The detected Java runtime is not compatible. jadx requires 64-bit Java 11 or newer.")
	messagesLauncherError.set("jadx could not be started. Extract the complete ZIP and use bin/jadx-gui.bat for diagnostics.")
