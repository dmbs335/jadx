...
public final class CompactionStats {
	...
	private final long packGarbageBytesReclaimed;
	private final int packCount;
	private final long elapsedMillis;

	public CompactionStats(long objectCount, long packedBytes, long looseBytesDeleted, long packGarbageBytesReclaimed,
			int packCount, long elapsedMillis) {
		this.objectCount = objectCount;
		this.packedBytes = packedBytes;
		this.looseBytesDeleted = looseBytesDeleted;
		this.packGarbageBytesReclaimed = packGarbageBytesReclaimed;
	...
	public long getPackGarbageBytesReclaimed() {
		return packGarbageBytesReclaimed;
	}
