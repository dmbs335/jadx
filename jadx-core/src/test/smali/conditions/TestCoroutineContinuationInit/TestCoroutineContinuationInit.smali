...
.method public static testObfuscated(Lconditions/c;)Ljava/lang/Object;
    .registers 4

    instance-of v0, p0, Lconditions/ObfuscatedContinuation;
    if-eqz v0, :new_state

    move-object v0, p0
    check-cast v0, Lconditions/ObfuscatedContinuation;
    iget v1, v0, Lconditions/ObfuscatedContinuation;->label:I
    const v2, -0x80000000
    and-int/2addr v2, v1
    if-eqz v2, :new_state
    ...
    const v2, -0x80000000
    sub-int/2addr v1, v2
    iput v1, v0, Lconditions/ObfuscatedContinuation;->label:I
    goto :return_state

    :new_state
    new-instance v0, Lconditions/ObfuscatedContinuation;
    invoke-direct {v0, p0}, Lconditions/ObfuscatedContinuation;-><init>(Lconditions/c;)V
...
.method public static testObfuscatedCast(Lconditions/c;)Ljava/lang/Object;
    .registers 4

    instance-of v0, p0, Lconditions/CastContinuation;
    if-eqz v0, :new_state

    move-object v0, p0
    check-cast v0, Lconditions/CastContinuation;
    iget v1, v0, Lconditions/CastContinuation;->label:I
    const v2, -0x80000000
    and-int/2addr v2, v1
    if-eqz v2, :new_state
    ...
    const v2, -0x80000000
    sub-int/2addr v1, v2
    iput v1, v0, Lconditions/CastContinuation;->label:I
    goto :return_state

    :new_state
    new-instance v0, Lconditions/CastContinuation;
    move-object v2, p0
    check-cast v2, Lkotlin/coroutines/jvm/internal/ContinuationImpl;
    invoke-direct {v0, v2}, Lconditions/CastContinuation;-><init>(Lkotlin/coroutines/jvm/internal/ContinuationImpl;)V
